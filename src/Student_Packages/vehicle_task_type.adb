...
package body Vehicle_Task_Type is
   ...
   Max_Forwards          : constant Integer  := 2;
   Coordinator_Dist      : constant Real     := 0.1;
   Waiting_Dist          : constant Real     := 0.4;
   Release_Delay         : constant Positive := 30;
